...
public class CommonGameMatchRequestActivity extends AppCompatActivity implements TabLayout.OnTabSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_common_game_match_request);
        initView();
        if (CommonUtils.isNetworkAvailable(CommonGameMatchRequestActivity.this)) {
            ...
            Toast.makeText(CommonGameMatchRequestActivity.this, Constants.INTERNET_ERROR, Toast.LENGTH_SHORT).show();
        }
        setListener();
    }

    private void initView() {
        mToolbar = (Toolbar) findViewById(R.id.activity_common_game_match_request_toolbar);
        mTeamsTitleTabLayout = (TabLayout) findViewById(R.id.activity_common_game_match_request_tl);
        mTeamScoreViewPager = (ViewPager) findViewById(R.id.activity_common_game_match_request_pager);
        mOpponentChatFabView = (FloatingActionButton) findViewById(R.id.activity_common_game_match_request_fab_chat);
        mUpdateScoreButton = (Button) findViewById(R.id.activity_common_game_match_request_btn_update_score);
        ...
        mProgressDialog = new Dialog(CommonGameMatchRequestActivity.this, android.R.style.Theme_Translucent_NoTitleBar);
        mProgressDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        mProgressDialog.setContentView(R.layout.progressdialog_layout);

        mApiInterface = ApiClient.getClient().create(ApiInterface.class);
        mPreferenceHelper = new PreferenceHelper(CommonGameMatchRequestActivity.this, Constants.APP_NAME, 0);
    ...
    private void getMatchDetails(MatchRequestModel matchRequestModel) {
        ...
        if (mOpponentTeamLogo != null) {
            Glide.with(CommonGameMatchRequestActivity.this).load(mOpponentTeamLogo).placeholder(R.drawable.profiledefaultimg).dontAnimate().into(mSecondTeamImageView);
        } else {
            Glide.with(CommonGameMatchRequestActivity.this).load(R.drawable.profiledefaultimg).dontAnimate().into(mSecondTeamImageView);
        }
        if (mMyTeamLogo != null) {
            Glide.with(CommonGameMatchRequestActivity.this).load(mMyTeamLogo).placeholder(R.drawable.profiledefaultimg).dontAnimate().into(mFirstTeamImageView);
        } else {
            Glide.with(CommonGameMatchRequestActivity.this).load(R.drawable.profiledefaultimg).dontAnimate().into(mFirstTeamImageView);
        }
                ...
                if (response.code() == 200) {
                    if (response.body() != null) {
                        try {
                            ...
                            mSportImageView.setImageResource(CommonUtils.sportCheck(mSportId));
                            ...
                            mOpponentSquadInfos = new ArrayList<SquadInfo>();
                            ...
                            if (mMatchType.equals("1")) {
                                if (mMatchStatus.equals("8") || mMatchStatus.equals("10") || mMatchStatus.equals("13")) {
                                    ...
                                    mUpdateScoreButton.setTextColor(ContextCompat.getColor(CommonGameMatchRequestActivity.this, R.color.white));
                                ...
                                case "20":
                                    ...
                                    if (object.has("set_team_form")) {
                                        ...
                                        if (opponentTeamFormStatus.equals("0") && myTeamFormStatus.equals("0")) {
                                            ...
                                            mUpdateScoreButton.setTextColor(ContextCompat.getColor(CommonGameMatchRequestActivity.this, R.color.white_25));
...
//                                            mBooking.setVisibility(View.GONE);
                           ...
                           /* if (CommonUtils.MatchType(mMatchType).equals("League")) {
                            ...
                            if (!venueBookingDate.equals("") && !venueBookingDate.equals("null")) {
                                ...
                                enableScoreUpdateButton(bookingDate, object);
                            } else {
                                ...
                                enableScoreUpdateButton(matchDate, object);
                            }
                        ...
                        CommonUtils.ErrorHandleMethod(CommonGameMatchRequestActivity.this, response);
                        if (mProgressDialog != null && mProgressDialog.isShowing()) {
                            mProgressDialog.dismiss();
                        }
                    }
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                CommonUtils.ServerFailureHandleMethod(CommonGameMatchRequestActivity.this, t);
                if (mProgressDialog != null && mProgressDialog.isShowing()) {
                    mProgressDialog.dismiss();
                }
            }
    ...
    private void enableScoreUpdateButton(String matchDate, JSONObject object) {
    ...
    public void HashGenerationServer() {
        final PreferenceHelper preferenceHelper = new PreferenceHelper(CommonGameMatchRequestActivity.this, Constants.APP_NAME, 0);
                ...
                try {
                    if (response.body() != null && response.code() == 200) {
                        ...
                        if (response.errorBody() != null) {
                            ...
                            if (!code.equals("500")) {
                                Toast.makeText(CommonGameMatchRequestActivity.this, msg, Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            String error = response.message();
                            Toast.makeText(CommonGameMatchRequestActivity.this, error, Toast.LENGTH_SHORT).show();
                        }
                    }
                } catch (Exception e) {
                    e.printStackTrace();
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                ...
                try {
                    if (t instanceof SocketTimeoutException) {
                        Toast.makeText(CommonGameMatchRequestActivity.this, R.string.timeout, Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(CommonGameMatchRequestActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
            ...
            if (data != null) {
                ...
                try {
                    ...
                    if (successresponse.equals("success")) {
                        Intent homeintent = new Intent(CommonGameMatchRequestActivity.this, HomeActivity.class);
                ...
                Toast.makeText(CommonGameMatchRequestActivity.this, "Payment not successful.", Toast.LENGTH_LONG).show(); // getString(R.string.could_not_receive_data)
            }
    ...
    public void launchSdkUI(PayuHashes payuHashes) {
        ...
        Intent intent = new Intent(CommonGameMatchRequestActivity.this, PayUBaseActivity.class);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.activity_common_game_match_request_fab_chat:
                Intent chatIntent = new Intent(CommonGameMatchRequestActivity.this, ChatDetailActivity.class);
                chatIntent.putExtra(Constants.BundleKeys.FCM_UID, (Serializable) chatUser);
                startActivity(chatIntent);
                finish();
                break;
            case R.id.activity_common_game_match_request_btn_update_score:
                if (mUpdateScoreButton.getText().toString().trim().equals(getResources().getString(R.string.schedule_match))) {
                    Intent intent = new Intent(CommonGameMatchRequestActivity.this, ScheduleActivity.class);
                    ...
                    Intent intent = new Intent(CommonGameMatchRequestActivity.this, MyTeamFormationActivity.class);
                    startActivity(intent);
                } else if (mUpdateScoreButton.getText().toString().trim().equals(getResources().getString(R.string.score_update))) {
                    String sportId = mPreferenceHelper.getString("teamsport", "");
                    Bundle bundle = new Bundle();
                    bundle.putString(Constants.BundleKeys.MY_TEAM_NAME, mMyTeamName);
                    bundle.putString(Constants.BundleKeys.OPPONENT_TEAM_NAME, mOpponentTeamName);
                    bundle.putString(Constants.BundleKeys.MY_TEAM_IMAGE, mMyTeamLogo);
                    bundle.putString(Constants.BundleKeys.OPPONENT_TEAM_IMAGE, mOpponentTeamLogo);
                    bundle.putString(Constants.BundleKeys.SCORE_UPDATE_STATUS, mMatchStatusView.getText().toString().trim());
                    bundle.putString(Constants.BundleKeys.MATCH_DATE, mMatchDateView.getText().toString().trim());
                    bundle.putString(Constants.BundleKeys.MATCH_VENUE, mMatchVenueView.getText().toString().trim());
                    bundle.putString(Constants.BundleKeys.SPORT_ID, mSportId);
                    bundle.putString(Constants.BundleKeys.TEAM_ID, mMyTeamId);
                    bundle.putString(Constants.BundleKeys.OPPONENT_TEAM_ID, mOpponentTeamId);
                    bundle.putString(Constants.BundleKeys.MATCH_ID, mMatchId);
                    bundle.putString(Constants.BundleKeys.TEAM_UPDATE_STATUS, mTeamsScoreUpdate);
                    bundle.putString(Constants.BundleKeys.OPPONENT_USER_SCORE_STATUS, mOpponentScoreUpdateStatus);
                    bundle.putString(Constants.BundleKeys.LOGIN_USER_SCORE_STATUS, mMyTeamScoreUpdateStatus);
                    bundle.putSerializable(Constants.BundleKeys.MY_TEAM_SQUAD, (Serializable) mMySquadInfos);
                    switch (sportId) {
                        case "1":
                        case "3":
                        case "6":
                        case "7":
                            Intent commonGameScoreUpdateIntent = new Intent(CommonGameMatchRequestActivity.this, SetGameScoreUpdateActivity.class);
                            commonGameScoreUpdateIntent.putExtras(bundle);
                            startActivityForResult(commonGameScoreUpdateIntent, Constants.SCORE_UPDATED);
                            break;
                        case "2":
                            Intent basketScoreUpdateIntent = new Intent(CommonGameMatchRequestActivity.this, ScoreUpdateBasketballActivity.class);
                            basketScoreUpdateIntent.putExtras(bundle);
                            startActivityForResult(basketScoreUpdateIntent, Constants.SCORE_UPDATED);
                            break;
                        case "5":
                            Intent footballScoreUpdateIntent = new Intent(CommonGameMatchRequestActivity.this, FootballScoreUpdateActivity.class);
                            footballScoreUpdateIntent.putExtras(bundle);
                            startActivityForResult(footballScoreUpdateIntent, Constants.SCORE_UPDATED);
                            break;
                    }
                }
                break;
    ...
    private class MatchRequestPagerAdapter extends FragmentStatePagerAdapter {
        ...
        MatchRequestPagerAdapter(FragmentManager supportFragmentManager, List<SquadInfo> opponentSquadInfos, List<MySquadInfo> mySquadInfos, List<String> tabTitles) {
