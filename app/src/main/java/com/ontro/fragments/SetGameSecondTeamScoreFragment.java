...
public class SetGameSecondTeamScoreFragment extends Fragment {
    public static Fragment newInstance() {
        return new SetGameSecondTeamScoreFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView mTeamScoreOverView = (RecyclerView) rootView.findViewById(R.id.fragment_set_game_team_score_overview_rv);
