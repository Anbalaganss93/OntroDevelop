...
public class FootballSecondTeamScoreFragment extends Fragment implements View.OnClickListener {
    ...
    public static Fragment newInstance(FootballScoreResponse footballScoreResponse) {
        FootballSecondTeamScoreFragment teamScoreFragment = new FootballSecondTeamScoreFragment();
        Bundle bundle = new Bundle();
        bundle.putSerializable(Constants.BundleKeys.SECOND_TEAM_PLAYER_SCORE, (Serializable) footballScoreResponse.getPlayerScore());
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mRootView = inflater.inflate(R.layout.fragment_football_second_team_score_overview, container, false);
        initView();
        if (getArguments() != null) {
            mPlayerScores = (List<FootballPlayerScoreUpdate>) getArguments().getSerializable(Constants.BundleKeys.SECOND_TEAM_PLAYER_SCORE);
    ...
    private void initView() {
        mPlayerScoreView = (TableLayout) mRootView.findViewById(R.id.fragment_football_second_team_score_overview_tl_players);
        mShowMorePlayerScoreView = (TextView) mRootView.findViewById(R.id.fragment_football_second_team_score_overview_tv_more);
        mShowLessPlayerScoreView = (TextView) mRootView.findViewById(R.id.fragment_football_second_team_score_overview_tv_less);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.fragment_football_second_team_score_overview_tv_more:
                showLessPlayer(mPlayerScores);
                break;
            case R.id.fragment_football_second_team_score_overview_tv_less:
                showMorePlayer(mPlayerScores);
                break;
        }
