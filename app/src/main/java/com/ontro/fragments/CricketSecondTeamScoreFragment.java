...
public class CricketSecondTeamScoreFragment extends Fragment implements View.OnClickListener {
    ...
    public static Fragment newInstance(CricketScoreResponse cricketScoreResponse) {
        CricketSecondTeamScoreFragment scoreFragment = new CricketSecondTeamScoreFragment();
        Bundle bundle = new Bundle();
        bundle.putSerializable(Constants.BundleKeys.SECOND_TEAM_SCORE, cricketScoreResponse);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            mCricketScoreResponse = (CricketScoreResponse) getArguments().getSerializable(Constants.BundleKeys.SECOND_TEAM_SCORE);
