...
public class SlideView extends RelativeLayout {
    ...
    public void setText(String slideText) {
        if(mSlideTextView != null) {
    ...
    public String getText() {
        if(mSlideTextView != null) {
            return mSlideTextView.getText().toString().trim();
        }
        return null;
    }
    ...
    public SlideView(Context context, AttributeSet attrs) {
        ...
        if (slideText != null && !slideText.isEmpty()) {
            ...
            mSlideTextView.setTypeface(myTypeface);
            mSlideTextView.setAllCaps(true);
            mSlideTextView.setText(slideText);
