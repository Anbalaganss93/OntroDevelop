...
//        frame.setBackgroundColor(background);
        ...
        pagerIndicator.setPageIndicatorColor(Color.parseColor("#595959"));
        ...
        ViewCompat.setBackgroundTintList(buttonCta.getChildAt(0), ColorStateList.valueOf(Color.parseColor("#595959")));
        ViewCompat.setBackgroundTintList(buttonCta.getChildAt(1), ColorStateList.valueOf(Color.parseColor("#595959")));
        ...
        int textColorButtonCta = buttonCtaTintMode == BUTTON_CTA_TINT_MODE_TEXT ?
                backgroundDarker : ContextCompat.getColor(this, R.color.white); // iconColor;
